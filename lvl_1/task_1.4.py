...
for key, value in titles.items():
    t_quantity = 0
    t_cost = 0
    for products in store[value]:
        multiplier = products['quantity']
        t_quantity += products['quantity']
        t_cost += products['price'] * multiplier
    print(key, " - ",t_quantity," шт, стоимость",t_cost," руб")
